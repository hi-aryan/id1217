...
public class FuelStationSimulation {
    public static void main(String[] args) {
        if (args.length < 6) {
            System.err.println("Usage: java FuelStationSimulation <maxNitrogen> <maxQuantum> <maxDocks> <numVehicles> <numSupply> <trips> [seed]");
...
// Compile all files
// javac FuelStation.java RegularVehicle.java SupplyVehicle.java FuelStationSimulation.java
